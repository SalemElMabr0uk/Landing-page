...
const Section9 = () => {
    ...
    return (
        <>
            <div className="p-16">
                <h1 className=' mt-[90px] ml-5 text-3xl font-semibold text-white'> Frequently Asked <span className='text_color_variation'> Questions</span></h1>

                <div className='mt-10 w-full flex flex-col justify-items-center text-white p-4 '>
