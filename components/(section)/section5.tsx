    ...
    <>
      <div className="bg-white ">
        ...
        <div className="flex-row flex p-2 ">
          ...
          <div className="w-[20%] hide-scrollbar overflow-hidden">
            <div className="h-[400px] m-6 shadow-md bg-white bg-opacity-40 rounded-lg p-1 dev transform transition-transform hover:ring-2 hover:ring-[#FF8ED0]">
              <div className="h-[60%]">
                <img src="https://media.istockphoto.com/id/940475680/photo/close-up-portrait-of-cheerful-brunet-young-man-in-jeans-shirt-crossing-hands-and-look-at.jpg?s=612x612&w=0&k=20&c=FFduZf0U7qxwIfkrzAPHXgxK2LoZf86i74rFtex6cLw=" className="flex h-full object-cover rounded" />
              </div>
              <h2 className="text-2xl font-semibold text-center h-[10%]">Name</h2>
              <p className="text-[#CBD5E1] text-sm justify-center h-[10%]">Post</p>
          ...
          <div className="w-[20%] hide-scrollbar overflow-hidden">
            <div className="h-[400px] m-6 shadow-md bg-white bg-opacity-40 rounded-lg p-1 dev transform transition-transform hover:ring-2 hover:ring-[#FF8ED0]">
              ...
              <h2 className="text-2xl font-semibold p-2 text-center h-[10%]">Name</h2>
              <p className="text-[#CBD5E1] text-sm text-center justify-center h-[10%]">Post</p>
          ...
          <div className="w-[20%] hide-scrollbar overflow-hidden">
            <div className="h-[400px] m-6 shadow-md bg-white bg-opacity-40 rounded-lg p-1 dev transform transition-transform hover:ring-2 hover:ring-[#FF8ED0]">
              ...
              <h2 className="text-2xl font-semibold text-center p-2 h-[10%]">Name</h2>
              <p className="text-[#CBD5E1] text-center text-sm justify-center h-[10%]">Post</p>
