          ...
          <div className="md:hidden">
            <div className="px-2 ">
              <div className='flex'>
                ...
                <Link href="/entrepreneur" className="block px-4  rounded-md text-white hover:bg-gray-700"> Roadmaps</Link>
              </div>
              <div className='flex'>
                <svg
                  width="16"
                ...
                <Link href="/#" className="block px-4 rounded-md text-white hover:bg-gray-700"> Projects</Link>
              </div>
              <div className='flex'>
                <svg
                  width="14"
                ...
                <Link href="/#" className="block px-4 rounded-md text-white hover:bg-gray-700">About us</Link>
              </div>
              <div className='flex items-center  gap-x-1 mx-auto '>
              <Link href="/Register" className="text-white block  hover:bg-gray-700 px-3 py-2 rounded-md font-medium">Sign up </Link>
