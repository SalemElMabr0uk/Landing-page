...
const Result: React.FC<any> = ({infoCardData}) => {
  ...
  return (
    <div className="max-md:w-full lg:gap-6 flex flex-col md:flex-row mt-6">
      <div className="flex flex-col p-9 font-bold rounded-lg border max-h-[50vh] md\:h-[380px] border-red-400 border-solid shadow-sm leading-[100%] max-md:w-5/6 ml-7 min-md:h-2/3 max-md:mt-10 h-[308px] w-[300px]" id="box1">
      ...
      <div className="flex flex-col p-9 font-bold rounded-lg border border-red-400 border-solid shadow-sm leading-[100%] max-md:w-5/6 ml-8 min-md:h-2/3 max-md:mt-10 h-[308px] w-[300px]" id="box2">
