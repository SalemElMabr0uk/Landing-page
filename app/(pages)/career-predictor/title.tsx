  ...
  return (<div>
    <div> 
        ...
        <h1>
          ...
          <span className="text-gradient ml-2">Predictor</span>
        </h1>
      </header> </div>
      <p className="ml-8  self-center mt-2 text-[28px] font-light tracking-tight leading-7 text-[#525252] max-md:max-w-full max-md:text-base font-sans">
